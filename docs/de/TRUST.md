...
`core/runtime.lock` pinnt den **Default**-Tag, URL und `PROTON_GE_SHA256` (AppImage/Flatpak). Rezepte können `proton_ge_tag` setzen; Alternativen liegen als `PROTON_GE_ALT_*` im Lock. Download prüft den Hash.
