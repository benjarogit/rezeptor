...
Aktuell nur der **Launcher**-JSON-Baum (aktuell ~762 Keys). Nicht abgedeckt: `core/locales/*.lang`, `scripts/locales/*.lang`, Rezept-`info.*.txt`.
...
`make i18n-check` prüft diese `.lang`-Bäume **nicht** — Sync weiterhin manuell bzw. per Review.
