...
Gleiche Dateinamen in beiden Ordnern (`README.md`, `RECIPES.md`, `RECIPE-AUTHORING.md`, …).  
Links **relativ im gleichen Ordner** halten — z. B. `[RECIPES.md](RECIPES.md)`, nicht `../en/…`.

Indizes: [docs/de/README.md](README.md) · [docs/en/README.md](../en/README.md)
