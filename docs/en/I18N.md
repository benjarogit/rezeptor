...
Same filenames in both folders (`README.md`, `RECIPES.md`, `RECIPE-AUTHORING.md`, …).  
Keep links **relative within the same folder** — e.g. `[RECIPES.md](RECIPES.md)`, not `../de/…`.

Indices: [docs/de/README.md](../de/README.md) · [docs/en/README.md](README.md)
