...
output::progress_done "Photoshop (m0nkrus 22.0) deinstalliert"
output::success "Rezept photoshop-m0nkrus-220 entfernt (Proton-GE unter ~/.local/share/wine-software/runtime/ bleibt)"
