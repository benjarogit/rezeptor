...
output::progress_done "Lightroom Classic deinstalliert"
output::success "Lightroom-Rezept entfernt (Katalog/Bilder außerhalb des Prefix bleiben, Proton-GE bleibt)"
