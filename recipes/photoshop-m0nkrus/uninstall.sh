...
output::progress_done "Photoshop (m0nkrus) deinstalliert"
output::success "Rezept photoshop-m0nkrus entfernt (Proton-GE unter ~/.local/share/wine-software/runtime/ bleibt)"
