...
output::section "ZA4 Baracuda Trainer — Deinstallation"
...
[ -n "$work" ] && [ -f "$work/ZA4-Trainer-Baracuda.exe" ] && rm -f "$work/ZA4-Trainer-Baracuda.exe" || true

output::progress_tick "Rezeptor-Daten"
recipe_hooks::purge_recipe_data

output::progress_done "Deinstalliert"
output::success "ZA4 Baracuda Trainer entfernt (Steam-Spiel unverändert)"
